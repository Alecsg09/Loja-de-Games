...
public class CategoriaController {
    ...
    public ResponseEntity <Categoria> getById(@PathVariable Long id){
       ...
       public ResponseEntity<Object> getByDisponibilidade(@PathVariable String disponibilidade){
          return ResponseEntity.ok(categoriaRepository.findAllByDisponibilidadeContainingIgnoreCase(disponibilidade));
